...
| [ADR-031](ADR-031-contrat-du-modele-regles-dictionnaire-exemples.md) | Le contrat du modèle réorganisé : dix règles RFC 2119 en tête et redites en liste de contrôle finale, dictionnaire de chaque champ (type JSON, obligatoire, défaut, valeurs), échange complet découverte comprise et erreurs courantes, commandes des exemples rendues dans le dialecte annoncé (`EXAMPLE_COMMANDS`), exemples rejoués contre l'adaptateur, le collecteur, le réducteur et la correction réels et dictionnaire comparé aux modèles, types JSON stricts à la frontière (fin de la coercition laxiste), exemple de correction du type tenté, borne de 60 Kio, `agentic-app protocol show`, texte maintenu en anglais | ADR-004, ADR-005, ADR-007, ADR-009, ADR-010, ADR-011, ADR-014, ADR-021, ADR-022, ADR-023, ADR-029, ADR-030 | accepté |
